...
<iframe width="560" height="315" src="https://www.youtube.com/embed/6sTb3VOkS6U?si=ZEB_YiX9qPjOhZJS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
Прочитайте конспект. Обновите знания по работе с табличками --- аггрегации (групировки), слияния, создание и модификация колонок.

Ссылка на конспекты прошлого курса: https://hse_mar.gitlab.io/mar221s/
(если у вас ссылка не открывается без VPN, скажите мне об этом, пожалуйста)
