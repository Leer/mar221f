...
users <- fread('https://raw.githubusercontent.com/Leer/mar221f/main/data/hw_1/users.csv')
# users[, dt := as.Date(install_dt)]

auth <- fread('https://raw.githubusercontent.com/Leer/mar221f/main/data/hw_1/auth.csv')
...
payments <- fread('https://raw.githubusercontent.com/Leer/mar221f/main/data/hw_1/payments.csv')
...
ltv <- merge(users, payments, by = c('user_id', 'media_source'), all.x = TRUE)
...
ltv_stat <- rbind(
  ltv_stat[, list(total_users = uniqueN(user_id),
             ...
             CPI = mean(CPI, na.rm = TRUE)), by = media_source],
...
```{r, include=FALSE}
# импортируем данные
onboarding <- fread('https://raw.githubusercontent.com/Leer/mar221f/main/data/hw_1/onboarding.csv')
